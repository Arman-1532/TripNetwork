...
const FlightSearch = ({ onSearch }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSearch({ origin, destination, date, adults: 1 });
  };

  return (
    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end bg-surface-container-low p-6 rounded-3xl border border-outline-variant/10 shadow-sm">
